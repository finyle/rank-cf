...
// 分形类问题： 多边形嵌套
// 分治问题： sumdiv， raid
// fractal(分形街道), sumdiv(a的b次幂的约数之和, 等比数列求和(快速幂 log(n))),  (raid(平面上的点中相距最近的两个点的距离) for-tedukuri-recursive)mergeSort  int tedukuri-recursive
...
//
// 数独， n皇后， bool tedukuri-recursive for-tedukuri-recursive
struct sudoku {
    bool dfs() {
    }
};

// tedukuri-ds: trie, heap, uf
struct uf_game {
...
// tree dp, void tedukuri-recursive for-tedukuri-recursive
